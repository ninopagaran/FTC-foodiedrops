...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({ drop, quantity, deliveryRequested, subtotal, deliveryFee, bookingFee, taxAmount, stripeFee, totalPrice, isOpen, onClose, onConfirm, user }) => {
      ...
      <div className="w-full max-w-2xl max-h-[90vh] bg-zinc-950 border-8 border-black relative overflow-hidden shadow-2xl">
        ...
        <div className="p-5 sm:p-8 md:p-14">
          <form onSubmit={handleNextStep} className="space-y-8 sm:space-y-12">
            <h2 id="checkout-modal-title" className="font-heading text-3xl sm:text-4xl md:text-5xl font-black italic uppercase tracking-tighter leading-none">Confirm Your Details</h2>
            ...
            <div className="bg-zinc-900 p-5 sm:p-8 border-4 border-zinc-800 space-y-3">
               ...
               <div className="flex justify-between text-xl sm:text-2xl font-black uppercase italic pt-2">
